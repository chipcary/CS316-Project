...
import GeneralSearchBarActions from './GeneralSearchBarActions';
 ...
 */
export default class GeneralSearchPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fixedHeader: true,
...
GeneralSearchBarPage.propTypes = {
